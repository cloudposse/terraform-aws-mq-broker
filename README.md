...
Instead pin to the release tag (e.g. `?ref=tags/x.y.z`) of one of our [latest releases](https://github.com/cloudposse/terraform-aws-mq-broker/releases).
...
|  [![Josh Myers][joshmyers_avatar]][joshmyers_homepage]<br/>[Josh Myers][joshmyers_homepage] | [![Connor Bell][makeshift_avatar]][makeshift_homepage]<br/>[Connor Bell][makeshift_homepage] |
|---|---|
  ...
  [makeshift_homepage]: https://github.com/makeshift
  [makeshift_avatar]: https://img.cloudposse.com/150x150/https://github.com/makeshift.png
